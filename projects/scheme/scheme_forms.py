...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        print("DEBUG: do_define_form", signature, expressions.rest)
        val = scheme_eval(expressions.rest.first, env)
        print("DEBUG: do_define_form", val)
        ...
        # BEGIN PROBLEM 10
        "*** YOUR CODE HERE ***"
        print("DEBUG: P10: 0", expressions.first, expressions.rest)
...
def do_lambda_form(expressions, env):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    print("DEBUG:", formals, expressions.rest.__repr__())
